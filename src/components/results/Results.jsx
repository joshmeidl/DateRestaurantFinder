...
class Results extends Component {
  ...
  componentDidMount() {
    ...
    if (localStorage.getItem("commute") === "Delivery Please") {
      uri =
        "https://cors-anywhere.herokuapp.com/https://api.yelp.com/v3/transactions/delivery/search?limit=10&term=" +
        encodeURI(localStorage.getItem("food"));
    } else {
      let dis = parseInt(localStorage.getItem("commute")) * 1609;
      uri =
        "https://cors-anywhere.herokuapp.com/https://api.yelp.com/v3/businesses/search?limit=10" +
        "&radius=" +
        dis +
        "&term=" +
        encodeURI(localStorage.getItem("food"));
